...
const SignUp = ({ toggleModal }) => {
  ...
  // const onAvatarUploaded = async (avatarUrl) => {
  //   try {
  ...
  //       uid: user.uid
  //     });
  //     const cometChatUser = await createCometChatAccount({
  //       cometChat: CometChat,
  //       uid: user.uid,
  //       name,
  //       avatar: avatarUrl,
        ...
        <div className="signup__container">
          ...
          <div className="signup__close">
            <img
              ...
              src="http://web.archive.org/web/20220609094439if_/https://static.xx.fbcdn.net/rsrc.php/v3/y2/r/__geKiQnSG-.png"
            />
          </div>
        </div>
